class MarkDiagram {
    ...
    addEndpoints(toId, sourceAnchors, targetAnchors) {
        ...
        for (var i = 0; i < sourceAnchors.length; i++) {
            ...
            instance.addEndpoint("flowchart" + toId, instance.sourceEndpoint, {
                anchor: sourceAnchors[i], uuid: sourceUUID
            });
        }
        for (var j = 0; j < targetAnchors.length; j++) {
            var targetUUID = toId + targetAnchors[j];
            instance.addEndpoint("flowchart" + toId, instance.targetEndpoint, { anchor: targetAnchors[j], uuid: targetUUID });
        }
    }
